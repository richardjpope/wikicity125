...
function get_mode(){
  result = 'none';
  if (window.location.search.indexOf('mode=run') > -1){
    result = 'run';
  } else if (window.location.search.indexOf('mode=example') > -1){
      result = 'example';
  }
...
function handleGetCurrentPosition(location){
    url = '/articles/' + location.coords.latitude + '/'+ location.coords.longitude + '?mode=' + get_mode()
